...
<script src="//code.tidio.co/rdk9tvuyxmk3zwsqpnnmj7r2uzekbm6m.js">    </PEGAR EL CODIGO DE TIDIO ACA :v>
>
</script>
...
<body>
	...
	<div class="menu">
		...
		<a href="?p=productos">Servicios</a>
...
<form method="post" action="?p=carrito">
	...
	<div class="footer">
		Copyright GICA PERÚ &copy; <?=date("Y")?>
	</div>
