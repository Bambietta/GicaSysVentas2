...
if(isset($enviar)){
	...
	$mysqli->query("INSERT INTO clientes (username,password,name,correo,numCelular) VALUES ('$username','$password','$nombre','$correo','$numCelular')");
	...
	<center>
		<form method="post" action="">
			<div class="centrar_login">
				...
				<div class="form-group">
					<input type="text" autocomplete="off" class="form-control" placeholder="e-mail" name="correo"/>
				</div>
                
                <div class="form-group">
					<input type="text" autocomplete="off" class="form-control" placeholder="Número de celular" name="numCelular"/>
				</div>
